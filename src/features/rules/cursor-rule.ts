...
export class CursorRule extends ToolRule {
  ...
  private static stringifyCursorFrontmatter(
    ...
    if (frontmatter.description) {
      ...
      // MDC "no unnecessary quotes" convention used for globs below). Newlines are
      // flattened because Cursor's simplified MDC parser can misread block scalars;
      // lineWidth: -1 prevents js-yaml from folding long single-line descriptions.
